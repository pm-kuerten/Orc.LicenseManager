...
public class LicenseViewModel : ViewModelBase
{
    ...
    /// </summary>
    public Command PurchaseLinkClick { get; }

    /// <summary>
    /// Gets the AboutSiteClick command.
    /// </summary>
    public Command AboutSiteClick { get; }

    /// <summary>
    /// Gets the RemoveLicense command.
    /// </summary>
    public TaskCommand RemoveLicense { get; }
    ...
    /// </summary>
    public TaskCommand ShowClipboard { get; }
    ...
    protected override async Task<bool> SaveAsync()
    {
        ...
        var messageResult = await _messageService.ShowAsync($"The license for {LicenseMode.ToDescriptionText()} has been successfully created, would you like to remove license for {oppositeLicenseMode.ToDescriptionText()}?", "Remove license confirmation", MessageButton.YesNo);
